...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$177 = isSupported$jscomp$inline_303;
...
function mountSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
  ...
  if (isHydrating) {
    ...
    includesBlockingLane(root$52, renderLanes) ||
    ...
    switch (fiber.tag) {
      ...
      case 3:
        var lane = requestUpdateLane(fiber),
          ...
          root$57 = scheduleUpdateOnFiber(fiber, lane, eventTime);
        null !== root$57 && entangleTransitions(root$57, fiber, lane);
  ...
  if (didBailout)
    for (var child$67 = completedWork.child; null !== child$67; )
      (newChildLanes |= child$67.lanes | child$67.childLanes),
        (subtreeFlags |= child$67.subtreeFlags & 7340032),
        (subtreeFlags |= child$67.flags & 7340032),
...
function attemptEarlyBailoutIfNoScheduledUpdate(
  ...
  switch (workInProgress.tag) {
    case 3:
      ...
      var root$111 = workInProgress.stateNode;
      pushProvider(workInProgress, CacheContext, current.memoizedState.cache);
      pushRootCachePool(root$111);
      resetHydrationState();
      break;
    case 5:
    ...
    case 10:
      ...
      break;
    case 13:
      root$111 = workInProgress.memoizedState;
      if (null !== root$111) {
        if (null !== root$111.dehydrated)
          return (
    ...
    case 19:
      ...
      root$111 = 0 !== (renderLanes & workInProgress.childLanes);
      enableLazyContextPropagation &&
        !root$111 &&
        (propagateParentContextChanges(
          current,
            ...
            switch (firstChild$jscomp$0.tag) {
              case 13:
                if (null !== firstChild$jscomp$0.memoizedState) {
                  var current$136 = firstChild$jscomp$0.alternate;
                  if (
                    null === current$136 ||
                    null === current$136.memoizedState
                  )
                    globalMostRecentFallbackTime = now();
                }
                break;
              case 22:
                var isHidden$138 = null !== firstChild$jscomp$0.memoizedState,
                  current$139 = firstChild$jscomp$0.alternate,
                  wasHidden$140 =
                    null !== current$139 && null !== current$139.memoizedState;
                deletions = firstChild$jscomp$0;
                a: {
                  i = deletions;
                  childToDelete = isHidden$138;
                      ...
                      switch (i.tag) {
                        ...
                        case 1:
                          ...
                          if (
                            ...
                            try {
                              (instance$jscomp$1.props = i.memoizedProps),
                                (instance$jscomp$1.state = i.memoizedState),
                                instance$jscomp$1.componentWillUnmount();
                            } catch (error) {
        ...
        if (0 !== (fiber.flags & 8772))
          switch (fiber.tag) {
            ...
            case 1:
              ...
              break;
            case 3:
              var updateQueue$131 = fiber.updateQueue;
              if (null !== updateQueue$131) {
                current = null;
                if (null !== fiber.child)
                ...
                commitUpdateQueue(fiber, updateQueue$131, current);
              }
              break;
            case 5:
              var instance$133 = fiber.stateNode;
              null === current &&
                fiber.flags & 4 &&
                ((current = instance$133),
    ...
    try {
      ...
      a: {
        ...
        if (
          ...
          var suspenseBoundary$61 = markNearestSuspenseBoundaryShouldCapture(
            returnFiber,
            sourceFiber,
            root,
            thrownValue
          ...
          switch (root.tag) {
            ...
            case 1:
              ...
              if (
                ...
                thrownValue &= -thrownValue;
                root.lanes |= thrownValue;
                var update$64 = createClassErrorUpdate(
                  root,
                  wakeable,
                  thrownValue
                );
                enqueueCapturedUpdate(root, update$64);
                break a;
              }
          }
          root = root.return;
                ...
                try {
                  switch (((fiberToDelete = deletions), fiberToDelete.tag)) {
                    ...
                    case 24:
                      ...
                      null !== fiberToDelete.alternate &&
                        (cache = fiberToDelete.alternate.memoizedState.cache);
                      var nextCache$147 = fiberToDelete.memoizedState.cache;
                      nextCache$147 !== cache &&
                        (nextCache$147.refCount++,
                        null != cache && releaseCache(cache));
                  }
                } catch (error) {
...
var Internals = {
  ...
  devToolsConfig$jscomp$inline_1387 = {
    findFiberByHostInstance: getClosestInstanceFromNode,
    bundleType: 0,
    version: "17.0.3",
    rendererPackageName: "react-dom"
  };
var internals$jscomp$inline_1791 = {
  bundleType: devToolsConfig$jscomp$inline_1387.bundleType,
  version: devToolsConfig$jscomp$inline_1387.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1387.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1387.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1387.findFiberByHostInstance ||
