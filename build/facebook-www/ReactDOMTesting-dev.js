...
var prevFreshCacheOnStack = createCursor(null); // Creates a new empty Cache instance with a ref-count of 0. The caller is responsible
...
function throwException(
  ...
  if (
    ...
    if (getIsHydrating() && sourceFiber.mode & ConcurrentMode) {
      ...
      var _suspenseBoundary = markNearestSuspenseBoundaryShouldCapture(
        returnFiber,
        sourceFiber,
        root,
        rootRenderLanes
    ...
    case LegacyHiddenComponent: {
...

      {
        ...
        if (
          ...
          _previousCache2 =
            workInProgress.alternate.memoizedState.cachePool.pool;
        }
    ...
    case CacheComponent: {
      {
        ...
        if (workInProgress.alternate !== null) {
          _previousCache3 = workInProgress.alternate.memoizedState.cache;
        }
...
function createRoot(container, options) {
  ...
  var concurrentUpdatesByDefaultOverride = null;
