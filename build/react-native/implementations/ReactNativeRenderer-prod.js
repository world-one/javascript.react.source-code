            ...
            switch (firstChild.tag) {
              case 13:
                if (null !== firstChild.memoizedState) {
                  var current$83 = firstChild.alternate;
                  if (null === current$83 || null === current$83.memoizedState)
            ...
            if (0 !== (firstChild.flags & 8772))
              switch (firstChild.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$79 = firstChild.updateQueue;
                  if (null !== updateQueue$79) {
                    current = null;
                    ...
                    commitUpdateQueue(firstChild, updateQueue$79, current);
                  }
                  break;
                case 5:
                  break;
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_961 = {
...
var internals$jscomp$inline_1223 = {
  bundleType: devToolsConfig$jscomp$inline_961.bundleType,
  version: devToolsConfig$jscomp$inline_961.version,
  rendererPackageName: devToolsConfig$jscomp$inline_961.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_961.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_961.findFiberByHostInstance ||
