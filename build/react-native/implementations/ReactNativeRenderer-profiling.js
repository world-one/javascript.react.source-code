            ...
            switch (firstChild.tag) {
              case 13:
                if (null !== firstChild.memoizedState) {
                  var current$91 = firstChild.alternate;
                  if (null === current$91 || null === current$91.memoizedState)
  ...
  for (nextEffect = finishedWork; null !== nextEffect; )
    if (
      ...
      for (root = finishedWork; null !== nextEffect; ) {
            ...
            if (0 !== (committedLanes.flags & 8772))
              switch (committedLanes.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$86 = committedLanes.updateQueue;
                  if (null !== updateQueue$86) {
                    var instance$87 = null;
                    if (null !== committedLanes.child)
                      switch (committedLanes.child.tag) {
                        case 5:
                          instance$87 = committedLanes.child.stateNode;
                          break;
                        case 1:
                          instance$87 = committedLanes.child.stateNode;
                      }
            ...
            if (committedLanes.flags & 512) {
              ...
              if (null !== ref) {
                ...
                if ("function" === typeof ref)
                  if (current.mode & 2)
                    try {
                      startLayoutEffectTimer(), ref(instance$87);
                    } finally {
                      recordLayoutEffectDuration(current);
                    }
                  else ref(instance$87);
                else ref.current = instance$87;
              }
            }
          } catch (error) {
        ...
        instance$87 = committedLanes.sibling;
        if (null !== instance$87) {
          instance$87.return = committedLanes.return;
          nextEffect = instance$87;
          break;
        }
...
var roots = new Map(),
  devToolsConfig$jscomp$inline_1001 = {
...
var internals$jscomp$inline_1283 = {
  bundleType: devToolsConfig$jscomp$inline_1001.bundleType,
  version: devToolsConfig$jscomp$inline_1001.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1001.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1001.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1001.findFiberByHostInstance ||
