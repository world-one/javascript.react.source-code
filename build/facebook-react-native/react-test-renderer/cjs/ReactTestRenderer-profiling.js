...
function bubbleProperties(completedWork) {
  ...
  if (didBailout)
    if (0 !== (completedWork.mode & 2)) {
      for (
        var treeBaseDuration$33 = completedWork.selfBaseDuration,
          child$34 = completedWork.child;
        null !== child$34;

      )
        (newChildLanes |= child$34.lanes | child$34.childLanes),
          (subtreeFlags |= child$34.subtreeFlags & 7340032),
          (subtreeFlags |= child$34.flags & 7340032),
          (treeBaseDuration$33 += child$34.treeBaseDuration),
          (child$34 = child$34.sibling);
      completedWork.treeBaseDuration = treeBaseDuration$33;
    } else
      for (
        treeBaseDuration$33 = completedWork.child;
        null !== treeBaseDuration$33;

      )
        (newChildLanes |=
          treeBaseDuration$33.lanes | treeBaseDuration$33.childLanes),
          (subtreeFlags |= treeBaseDuration$33.subtreeFlags & 7340032),
          (subtreeFlags |= treeBaseDuration$33.flags & 7340032),
          (treeBaseDuration$33.return = completedWork),
          (treeBaseDuration$33 = treeBaseDuration$33.sibling);
  else if (0 !== (completedWork.mode & 2)) {
    treeBaseDuration$33 = completedWork.actualDuration;
    child$34 = completedWork.selfBaseDuration;
    for (var child = completedWork.child; null !== child; )
      (newChildLanes |= child.lanes | child.childLanes),
        (subtreeFlags |= child.subtreeFlags),
        (subtreeFlags |= child.flags),
        (treeBaseDuration$33 += child.actualDuration),
        (child$34 += child.treeBaseDuration),
        (child = child.sibling);
    completedWork.actualDuration = treeBaseDuration$33;
    completedWork.treeBaseDuration = child$34;
  } else
    for (
      treeBaseDuration$33 = completedWork.child;
      null !== treeBaseDuration$33;
      ...
      (newChildLanes |=
        treeBaseDuration$33.lanes | treeBaseDuration$33.childLanes),
        (subtreeFlags |= treeBaseDuration$33.subtreeFlags),
        (subtreeFlags |= treeBaseDuration$33.flags),
        (treeBaseDuration$33.return = completedWork),
        (treeBaseDuration$33 = treeBaseDuration$33.sibling);
                ...
                if ("function" === typeof currentRef)
                  if (deletions.mode & 2)
                    try {
                      ...
                      recordLayoutEffectDuration(deletions);
                    }
  ...
  for (nextEffect = finishedWork; null !== nextEffect; ) {
    ...
    if (0 !== (fiber.subtreeFlags & 8772) && null !== firstChild)
      ...
      for (fiber = finishedWork; null !== nextEffect; ) {
          ...
          try {
            if (0 !== (firstChild.flags & 8772))
              switch (firstChild.tag) {
                ...
                case 15:
                  ...
                  else commitHookEffectListMount(5, firstChild);
                  break;
                case 1:
                  ...
                  break;
                case 3:
                  var updateQueue$80 = firstChild.updateQueue;
                  if (null !== updateQueue$80) {
                    var instance$81 = null;
                    if (null !== firstChild.child)
                      switch (firstChild.child.tag) {
                        case 5:
                          instance$81 = getPublicInstance(
                            firstChild.child.stateNode
                          );
                          break;
                        case 1:
                          instance$81 = firstChild.child.stateNode;
                      }
                    commitUpdateQueue(firstChild, updateQueue$80, instance$81);
                  }
                  break;
                case 5:
                  break;
                ...
                case 4:
                  break;
                case 12:
                  var _finishedWork$memoize2 = firstChild.memoizedProps,
                    onCommit = _finishedWork$memoize2.onCommit,
                    onRender = _finishedWork$memoize2.onRender,
                    effectDuration = firstChild.stateNode.effectDuration;
                  instance$81 = commitTime;
                  current = null === current ? "mount" : "update";
                  currentUpdateIsNested && (current = "nested-update");
                  "function" === typeof onRender &&
                    onRender(
                      firstChild.memoizedProps.id,
                      current,
                      firstChild.actualDuration,
                      firstChild.treeBaseDuration,
                      firstChild.actualStartTime,
                      instance$81
                    );
                  ...
                  enqueuePendingPassiveProfilerEffect(firstChild);
                  var parentFiber = firstChild.return;
            ...
            if (firstChild.flags & 512) {
              ...
              if (null !== ref) {
                ...
                switch (current.tag) {
                  case 5:
                    instance$81 = getPublicInstance(instance$jscomp$0);
                    break;
                  default:
                    instance$81 = instance$jscomp$0;
                }
                if ("function" === typeof ref)
                  if (current.mode & 2)
                    try {
                      startLayoutEffectTimer(), ref(instance$81);
                    } finally {
                      recordLayoutEffectDuration(current);
                    }
                  else ref(instance$81);
                else ref.current = instance$81;
              }
            }
          } catch (error) {
            captureCommitPhaseError(firstChild, firstChild.return, error);
        ...
        instance$81 = firstChild.sibling;
        if (null !== instance$81) {
          instance$81.return = firstChild.return;
          nextEffect = instance$81;
          break;
        }
        nextEffect = firstChild.return;
      }
...
var devToolsConfig$jscomp$inline_835 = {
...
var internals$jscomp$inline_1056 = {
  bundleType: devToolsConfig$jscomp$inline_835.bundleType,
  version: devToolsConfig$jscomp$inline_835.version,
  rendererPackageName: devToolsConfig$jscomp$inline_835.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_835.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_835.findFiberByHostInstance ||
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1057 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1057.isDisabled &&
    hook$jscomp$inline_1057.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1057.inject(
        internals$jscomp$inline_1056
      )),
        (injectedHook = hook$jscomp$inline_1057);
    } catch (err) {}
}
